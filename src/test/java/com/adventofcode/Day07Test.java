...
public class Day07Test {
    ...
    @Test
    void testExample() {
        assertThat(Intcode.thrusterSignal("3,15,3,16,1002,16,10,16,1,16,15,15,4,15,99,0,0", Arrays.asList(4L, 3L, 2L, 1L, 0L))).isEqualTo(43210);
    }
    ...
    void testInputPartOne() throws IOException {
        Pair<List<Long>, Long> max = Intcode.maxThrusterSignal(FileUtils.readLine("/day/7/input"), 0L, 1L, 2L, 3L, 4L);
    ...
    void testInputPartTwo() throws IOException {
        Pair<List<Long>, Long> max = Intcode.maxThrusterSignal(FileUtils.readLine("/day/7/input"), 9L, 8L, 7L, 6L, 5L);
